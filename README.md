...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Mental%20Health%20Ally-%23A78BFA?style=for-the-badge&logo=handshake" />
</p>
...
Hi, I’m **Paras Mottan**, a MERN Stack Developer who loves crafting meaningful digital experiences.  
I’m building [**Whispra.in**] — an **Omegle-style anonymous chat platform** designed to support those dealing with **depression & anxiety**.

> I believe code can do more than function — it can heal, express, and connect. 🤝
...
- 🫂 **Whispra.in** – Mental health focused anonymous chat (inspired by Omegle)
- 🌈 **My Developer Portfolio** – Smooth scroll, animations, and clean UI using GSAP + Locomotive
- 🔐 **Secure Auth App** – Built with Express, JWT, and MongoDB

---

## 🧠 Currently Learning

- 🧵 **Socket.IO** & **WebRTC** for real-time chat features  
- 🎮 **Three.js** for creative 3D UI/UX  
- 🧱 Building a **custom UI component kit** using Tailwind & Headless UI
...
<p align="center"><i>Let’s build not just websites... but safe spaces online.</i></p>
